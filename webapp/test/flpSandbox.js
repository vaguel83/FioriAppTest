		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori First App",
									"targetURL": "#btpacademyfiorifirstapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"btpacademyfiorifirstapp-display": {
								"semanticObject": "btpacademyfiorifirstapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=btp.academy.fiorifirstapp",
									"url": sap.ui.require.toUrl("btp/academy/fiorifirstapp")
								}
							}
						}
					}
